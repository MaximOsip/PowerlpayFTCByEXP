...
@Autonomous(name = "AutoLeft", group = "EXP")

public class AutoLeftAngle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            while (!encoderMove(750) & opModeIsActive()) {
                setPower(-sp, sp, sp, -sp);
                telemetry.addData("ENCODER", left_1.getCurrentPosition());
        ...
        if(place == 1) {
            while(opModeIsActive()) {
                ...
                while (!encoderMove(350) & opModeIsActive()) {
                    setPower(sp, sp, -sp, -sp);
                    telemetry.addData("ENCODER", left_1.getCurrentPosition());
